...
class __TwigTemplate_283c9b09cddd13df8fcc2702370f72c1e970b47e74ece300c04311489e209b33 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
          ...
          <table class=\"pma-table data\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["slave"]) {
                ...
                echo "                <tr>
                  <td class=\"value\">";
                // line 31
                echo twig_escape_filter($this->env, (($__internal_compile_0 = $context["slave"]) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["Server_id"] ?? null) : null), "html", null, true);
                echo "</td>
                  <td class=\"value\">";
                // line 32
                echo twig_escape_filter($this->env, (($__internal_compile_1 = $context["slave"]) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1["Host"] ?? null) : null), "html", null, true);
                echo "</td>
                </tr>
              ";
            }
      ...
      <li>
        <a href=\"";
            ...
            echo "\" data-post=\"";
            echo PhpMyAdmin\Url::getCommon(($context["url_params"] ?? null), "", false);
...
";
    ...
    {
        return new Source("", "server/replication/master_replication.twig", "/Users/muhsinzyne/public_html/phpmyadmin/templates/server/replication/master_replication.twig");
    }
}
